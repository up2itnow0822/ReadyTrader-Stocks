...
- **Tests**: 48 new tests, including real-bar fixtures (SVB, COVID, 2025 tariff shock, and days the rule must allow) whose expectations come from the independent research code.
